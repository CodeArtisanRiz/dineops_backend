...
WSGI_APPLICATION = 'dineops.wsgi.application'
...
# Update the ROOT_URLCONF
ROOT_URLCONF = 'dineops.urls'

# Update the WSGI application
WSGI_APPLICATION = 'dineops.wsgi.application'

# Update INSTALLED_APPS if there are any references to dineops
# For example, if you have 'dineops' in INSTALLED_APPS, change it to 'dineops'